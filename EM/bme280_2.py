...
class BME280Sensor:
    ...
    def read_data(self):
        ...
        return  temp_raw, pres_raw #pres_rawを返す
    ...
    def altitude(self, pressure, temperature, qnh = 1013.25):
...
temp_raw, pres_raw = sensor.read_data()  # 生データ（温度・気圧）を取得
pressure = sensor.compensate_P(pres_raw)  # 気圧補正
temperature = sensor.compensate_T(temp_raw)  # 温度補正
