import smbus
import time
#import RPi.GPIO as GPIO  # RPi.GPIO モジュールのインポート

class BME280:
    # GPIOの設定
    #GPIO.setmode(GPIO.BCM)  # GPIO番号をBCMモードで指定
    #GPIO.setup(2, GPIO.IN, pull_up_down=GPIO.PUD_UP)  # SDAピン (GPIO2)
    #GPIO.setup(3, GPIO.IN, pull_up_down=GPIO.PUD_UP)  # SCLピン (GPIO3)
    ...
    def get_altitude(self, qnh=1013.25, manual_temperature=None):
        ...
        temperature, pressure = self.compensate_P()
