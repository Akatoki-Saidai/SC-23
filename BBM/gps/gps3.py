...
# 測定値の出力用
#import print as csv# csv_print->print
import make_gps_csv
...
class MicropyGPS(object):
    ...
    def latitude(self):
        ...
        if self.coord_format == 'dd':
            ...
            make_csv.print('lat', decimal_degrees)  # 測地値を記録
    ...
    def longitude(self):
        ...
        if self.coord_format == 'dd':
            ...
            make_csv.print('lon', decimal_degrees)  # 測地値を記録
    ...
    def date_string(self, formatting='s_mdy', century='20'):
        ...
        make_csv.print('gnss_time', f'{century}{year}-{month}-{day}T{self.timestamp[0]}:{self.timestamp[1]}:{self.timestamp[2]}Z')  # 測定値を記録
        return date_string
